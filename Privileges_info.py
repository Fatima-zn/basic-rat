...
class PrivilegesInfo():
    ...
    def get_windows_token_privilges(self):
        ...
        try:
            ...
            result = subprocess.run(['whoami', '/priv'], **kwargs)
    ...
    def has_vulnerable_services(self):
        ...
        try:
            ...
            result = subprocess.run(['sc', 'query'], **kwargs)
            ...
            if result.returncode == 0:
                ...
                for line in lines:
                    ...
                    if line.startswith('SERVICE_NAME:'):
                        ...
                        perm = subprocess.run(['sc', 'qc'], **kwargs)
    ...
    def has_writable_scheduled_tasks(self):
        try:
            ...
            result = subprocess.run(['schtasks', '/query', '/fo', 'LIST'], **kwargs)
            if result.returncode == 0:
